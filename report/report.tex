...
\HRule \\[0.4cm]
{ \huge \bfseries Parallel Tree Search In Playing The Game 2048}\\[0.4cm] % Title of your document \\
  \larger COMS4040: High Performance Computing and Scientific Data Management Group Assignment
  \large 21 April 2017
\HRule \\[1.5cm]
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.3\textwidth]{images/tree}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.3\textwidth]{images/tree_mpi}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.3\textwidth]{images/tree_cuda}
...
\section{Results and discussionss
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.3\textwidth]{images/serial_graph}
...
\begin{figure}[H]
	...
	\caption{MPI execution time where number of nodes is divided amongst 4 processes evenly}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1.3\textwidth]{images/mpi_16procs}
	\caption{MPI execution time where number of nodes is divided amongst 16 processes evenly}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1.3\textwidth]{images/mpi_32procs}
	\caption{MPI execution time where number of nodes is divided amongst 32 processes evenly}
\end{figure}
